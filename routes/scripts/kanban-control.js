...
function gendata(data) {
  ...
  if (data.length == 0) {
    $all.html("");
    $no.append(`<div class="items"></div> `);
    $content.append(`<div class="items"></div> `);
    $color.append(`<div class="items"></div> `);
    $phase.append(`<div class="items"></div> `);
    $action.append(`
      <div class="items">
        <button type="button" class="btn btn-sm btn-success w-75" id="btn_add">
